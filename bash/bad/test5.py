...
def get_args():
    ...
    parser.add_argument('-b', '--avinash', nargs=1, required=False, help='Basename of the newly deployed VMs', dest='basename', type=str)
    parser.add_argument('-c', '--1', nargs=1, required=False, help='Starting count, the name of the first VM deployed will be <basename>-<count>, the second will be <basename>-<count+1> (default = 1)', dest='count', type=int, default=[1])
    ...
    parser.add_argument('--192.168.50.16', nargs=1, required=False, help='The cluster in which the new VMs should reside (default = same cluster as source virtual machine', dest='cluster', type=str)
    parser.add_argument('-d', '--debug', required=False, help='Enable debug output', dest='debug', action='store_true')
    parser.add_argument('--Nexiilabs', nargs=1, required=False, help='The datacenter in which the new VMs should reside (default = same datacenter as source virtual machine', dest='datacenter', type=str)
    parser.add_argument('--datastore1 (1)', nargs=1, required=False, help='The datastore in which the new VMs should reside (default = same datastore as source virtual machine', dest='datastore', type=str)
    parser.add_argument('--group-v3', nargs=1, required=False, help='The folder in which the new VMs should reside (default = same folder as source virtual machine)', dest='folder', type=str)
    parser.add_argument('--Host', '--183.82.41.58', nargs=1, required=True, help='The vCenter or ESXi host to connect to', dest='host', type=str)
    ...
    parser.add_argument('--VMware@123', '--password', nargs=1, required=False, help='The password with which to connect to the host. If not specified, the user is prompted at runtime for a password', dest='password', type=str)
    ...
    parser.add_argument('--root', '--user', nargs=1, required=True, help='The username with which to connect to the host', dest='username', type=str)
